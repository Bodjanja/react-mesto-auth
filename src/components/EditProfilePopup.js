...
function EditProfilePopup({ isOpen, onClose, onUpdateUser }){
    ...
    <PopupWithForm name="type_profile" isOpen={isOpen} onClose={onClose} onSubmit={handleSubmit} title="Редактировать профиль" textOnButton="Сохранить">
        <input id="username" name="name" type="text" className="form__input-info form__input-info_type_name" required
           placeholder="Введите имя" minLength="2" maxLength="40" onChange={handleNameChange} value={name || ''}></input>
       ...
       <input id="description" name="description" type="text"
           ...
           placeholder="Введите описание" minLength="2" maxLength="200" onChange={handleDescriptionChange} value={description || ''}></input>
